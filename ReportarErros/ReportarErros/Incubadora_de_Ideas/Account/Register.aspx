<%@ Page Title="Register" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Incubadora_de_Ideas.Account.Register" %>
    ...
    <div class="form-horizontal" role="form">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-6 col-md-8 ">
                ...
                <asp:SqlDataSource runat="server" ID="secret_sql" ConnectionString='<%$ ConnectionStrings:DefaultConnection %>' SelectCommand="SELECT * FROM [PerguntaSecreta] ORDER BY [secret]"></asp:SqlDataSource>
