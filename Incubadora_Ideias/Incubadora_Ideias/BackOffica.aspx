        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-id="5" data-dismiss="modal" aria-label="Close" onclick="Editar"><span aria-hidden="true">&times;</span></button>
           ...
           <asp:TemplateField HeaderText="Foto" SortExpression="Foto">
                    ...
                    <ItemTemplate>
                        ...
                        <asp:TemplateField ShowHeader="False " HeaderText="Editar">
                            <ItemTemplate>
                                <button type="button" class="btn btn-primary " data-toggle="modal" data-target="#EditarUser">
                                    Editar  
                                </button>
